...
<body class="bg-white">
    ...
    <nav id="a" class="navbar navbar-expand-md navbar-light bg-light navbar-laravel navbar-fixed-top" style="min-height: 80px;">
            <div class="container">
                <a class="navbar-brand text-danger font-weight-bold" style="font-family: Segoe Script" href="{{ url('/') }}">
    ...
    <footer class="page-footer bg-light" style="margin-top: 70px;">
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center text-black-50 py-3" style="background-color: #E8EAED;">© 2018 Copyright:
            <a class="dark-grey-text" href="">hajurkoProperty.com</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
