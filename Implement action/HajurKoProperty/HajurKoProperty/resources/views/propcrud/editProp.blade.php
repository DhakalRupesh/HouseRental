  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-6"  style="">
      <div class="card" style="width: 22rem;">
        ...
        <a href="{{ URL::to('/editProp', $datas->id)}}" type="button" class="btn btn-Success mb-1" style="border-radius: 25px;">View and Edit</a>
            <form action="{!! url('/editProp',[$datas->id]) !!}" method="POST">
                @csrf
                {!! method_field('DELETE') !!}
                <button type="submit" class="btn btn-danger" ><i value="delete" class="fa fa-trash pr-1"></i>Delete</button>
            </form>   
        </div>
      </div>
    </div>
