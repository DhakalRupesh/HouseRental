                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="suitable" id="inlineRadio1" value="Sale">
                                <label class="form-check-label" for="inlineRadio1">Office</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="suitable" id="inlineRadio2" value="Rent">
